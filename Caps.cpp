...
GstCaps* Caps::OPUS = gst_caps_new_simple("application/x-rtp",
...
GstCaps* Caps::VORBIS = gst_caps_new_simple("application/x-rtp",
		"media", G_TYPE_STRING, "audio",
		"payload", G_TYPE_INT, 96,
...
GstCaps* Caps::L16 = gst_caps_new_simple("application/x-rtp",
		"media", G_TYPE_STRING, "audio",
		"payload", G_TYPE_INT, 96,
		"clock-rate", G_TYPE_INT, 44100,
